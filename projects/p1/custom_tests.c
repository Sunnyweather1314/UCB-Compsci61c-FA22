...
bool test_body_to_tail() {
  // TODO: Implement this function.
  if (!assert_true("body_to_tail('<')", body_to_tail('<') == 'a')) {
    return false;
  }
  return true;
}
...
bool test_head_to_body() {
  // TODO: Implement this function.
  if (!assert_true("head_to_body('D')", head_to_body('D') == '>')) {
    return false;
  }
  return true;
}
...
bool test_get_next_x() {
  // TODO: Implement this function.
  if (!assert_true("get_next_row(16, 'S')", get_next_row(16, 'S') == 17)) {
    return false;
  }
  return true;
}
...
bool test_get_next_y() {
  // TODO: Implement this function.
  if (!assert_true("get_next_col(16, '<')", get_next_col(16, '<') == 15)) {
    return false;
  }
  return true;
}
