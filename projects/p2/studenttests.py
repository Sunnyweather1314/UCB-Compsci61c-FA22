...
class TestAbsLoss(unittest.TestCase):
    ...
    def test_length_6(self):
        t = AssemblyTest(self, "../coverage-src/abs_loss.s")
        array0 = t.array([0, 1, 2, 3, 4, 5])
        array1 = t.array([3, 1, 2, 1, 9, 3])
        t.input_array("a0", array0)
        t.input_array("a1", array1)
        t.input_scalar("a2", len(array0))
        array2 = t.array([3, 0, 0, 2, 5, 2])
        t.input_array("a3", array2)
        t.call("abs_loss")
...
class TestSquaredLoss(unittest.TestCase):
    def test_simple(self):
        ...
        t.input_array("a3", array2)
        t.call("squared_loss")
        t.check_array(array2, [9, 0, 0, 4, 25, 4])
...
class TestZeroOneLoss(unittest.TestCase):
    def test_simple(self):
        ...
        t.check_array(array2, [0, 1, 1, 0, 0, 0])
        t.execute()
